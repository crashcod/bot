...
console.log(
    decodeMessage(
        "gACAEgADAAFjAgEAAWEDAA0AAXASAAMAAWMIAAlQSU5HX1BPTkcAAXIE/////wABcBIABAAEZGF0YRIAAAACaWQEAAAADQAEaGFzaAgAIGMwOGNmMjM4NjgxMmE4M2M3ZjYyOWRlMWQ1YzU3MmI5AAl0aW1lc3RhbXAFAAA6B/QD8TY="
    )
);
/**
 * 
