...
console.log(
    decodeMessage(
        "gACcEgADAAFjAgEAAWEDAA0AAXASAAMAAWMIAA1BUFBST1ZFX0NMQUlNAAFyBP////8AAXASAAQABGRhdGESAAEAEWJsb2NrX3Jld2FyZF90eXBlBAAAAAEAAmlkBAAAABMABGhhc2gIACBlNDQwMGRiZDI5YTYzYzc0ZjEwYjJlNTZiNTA1YTQxNgAJdGltZXN0YW1wBQAAOgiJk4T6"
    )
);
/**
 * 
